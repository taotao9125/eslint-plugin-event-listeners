        ...
        return {
            ...
            'Program:exit'() {
                ...
                removeAllCache.forEach((delAllItem) => {
                    ...
                    // To prevent delService[delAllItem.delType] return unexpected undefined
                    if (delService[delAllItem.delType]) {
                ...
                Object.entries(nodes).forEach(entries => {
                    Object.keys(entries[1]).forEach(eventType => {
                        ...
                        // Developer call removeListener but do not call addListener
                        // that is not a problem
                        if(methodName === 'removeEventListener' || methodName === 'removeListener') {
                            return;
                        }
